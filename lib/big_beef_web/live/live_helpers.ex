defmodule BigBeefWeb.LiveHelpers do
  ...
  @doc """
  Renders a component inside the `BigBeefWeb.ModalComponent` component.
  ...
  ## Examples
      ...
      <%= live_modal @socket, BigBeefWeb.ClipLive.FormComponent,
        id: @clip.id || :new,
        action: @live_action,
        clip: @clip,
  ...
  def live_modal(_socket, component, opts) do
    ...
    live_component(socket, BigBeefWeb.ModalComponent, modal_opts)
  end
  ...
  def generate_oauth_url do
    %{host: BigBeefWeb.Endpoint.host(), port: System.get_env("PORT", "4000")}
